...
if __name__ == "__main__":
	...
	group2.add_argument('--template_name', '-T', choices = ('ecearth', 'ecearth3', 'ifs', 'ifs3', 'nemo'), type = str, default = 'master', required = True) ##find a way to allow only compatible ones with model_name
