...
copyright = '2021, Barcelona Supercomputing Center, BSC'
author = 'Earth Science Department, Barcelona Supercomputing Center, BSC'
...
latex_documents = [
    (master_doc, 'autosubmit.tex', 'autosubmit Documentation',
     'Domingo Manubens - Joan López', 'manual'),
]
