...
class Job:
    ...
    def update_content(self):
        ...
        if (self._parameters['PROJECT_TYPE'].lower() != "none"):
            template.read_localsetup_file(LOCAL_ROOT_DIR + "/" + self._expid + "/"  + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_LOCALSETUP'])
            template.read_remotesetup_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_REMOTESETUP'])
            template.read_initialisation_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_INI'])
            template.read_simulation_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_SIM'])
            template.read_postprocessing_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_POST'])
            template.read_cleaning_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_CLEAN'])
            template.read_transfer_file(LOCAL_ROOT_DIR + "/" + self._expid + "/" + LOCAL_PROJ_DIR + "/" + self._parameters['FILE_TRANS'])
