...
# --------------------------------------------------------------------
#
def _mnscript_generator(url, logger, jd, ppn, mn_version, queue=None, ):
...
'queue=%s', but job description tries to a differnt queue: '%s'. Using '%s'." %
        ...
        try:
            ...
            script = _mnscript_generator(url=self.rm, logger=self._logger,
                                         jd=jd, ppn=self.ppn,
                                         mn_version=self._commands['bjobs'],
                                         queue=self.queue,
                                         )
